class ZeroOilHealthyFoodResponseData {
  String? status;
  String? message;
  List<Data>? data;

  ZeroOilHealthyFoodResponseData({this.status, this.message, this.data});

  ZeroOilHealthyFoodResponseData.fromJson(Map<String, dynamic> json) {
    status = json['status'];
